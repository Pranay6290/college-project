...
def batch_graph(arg):
    ...
    plt.title('Overall Grades vs No. of Students', color='blue', weight='heavy')
    plt.axis('equal')
    plt.show()
...
def department_graph():
    ...
    ax.set_facecolor("Black")
    fig.set_facecolor("Black")
    ax.set_xlabel("X axis", color="yellow")
    ax.set_ylabel("Y axis", color="yellow")
    ...
    plt.title('Histogram of Average of Students vs Batch', color='red', pad=17, fontweight='bold')
    plt.xlabel('Average----------------->')
...
print("<------------- 'project Name :- Student Examination Portal'---------------------------------->\n")
print("       <-------------------'Created By :- pranay gupta'----------------------->\n")
print("<------------------------'Branch :- CSE (CSBS)'------------------------------------------->\n")
print("       <-------------------'Year-Section :- (1st & 'F')'------------------------>\n")
print("<-------------------------'Roll No :- (40)'-------------------------------------------------->\n")

print("<----------------------'Short form of the all Branches that are valid or Existing in College--------------->\n")
print('\n', 'Computer Sience and Engineering : CSE', '\n',
      ...
      'Computer Sience and Engineering and Internet of Things and Syber Security : CSE (IOTCSBT)', '\n',
      'Information Technology : IT', '\n',
      'Electrical and Communications Engineering : ECE', '\n',
      'Mechanical Engineering : ME', '\n',
      'Electrical Engineering : EE', '\n')

print("<------------------'Details of thye Student'----------------------------------->\n")

student_no = int(input("Enter the number of students :- \n"))

for i in range(student_no):
    name = input("Enter the name of Student :- : ")
    batch = input("Enter the batch session of the student (e.g. 2020-24) : ")
    stream = input("Enter the Branch of the student (e.g. CSE) : ")
    ...
    if duplicate('Student.csv', student_id, 0):
        ...
        marks_lst = eval(input("Enter the Marks list out of 100 :- "))
        total_marks = add(marks_lst)
        print()

        with open(f"{path}/ReportCards/{student_id}_{''.join(name.split())}.txt", 'w') as f:

            f.writelines([f'                                                      Report Card:-  \n\n\n',
                          f'Name of the student : {name} \n',
